...
function create_new_location () {
	...
	$("#app-locations-create_location")"click", function () {
		var location = {},
	...
	$("#app-locations-cancel_location")"click", function () {
...
$(function () {
	...
	$("#app-locations-add_location")"click", create_new_location);
	$("#app-locations-list .app-locations-delete")"click", delete_location);
	$("#app-locations-list .app-locations-edit")"click", edit_location);

	// Inline save
	$(document)'app-appointment-inline_edit-save_data', save_inline_appointment_data);
