<table class="form-table">
	...
	<tr>
		...
		<td colspan="2">
			...
			<p class="description"><?php _e( 'Sende eine E-Mail an die entsprechenden Clienten und Provider, wenn ein Termin entfernt wurde.', 'appointments' ) ?><br/><?php _e( '<b>Note:</b> This email will only be sent for explicitly removed appointments only. The appointments that get removed due to expiration will not be affected.', 'appointments' ) ?>
			</p>
		</td>
	</tr>
