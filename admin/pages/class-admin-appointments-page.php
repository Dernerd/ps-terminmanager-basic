...
class Appointments_Admin_Appointments_Page {
	 ...
	 */
	function deleted() {
		echo '<div class="updated fade"><p><b>[Appointments+]</b> '. __( 'Ausgewählte Datensätze gelöscht.','appointments' ).'</p></div>';
	}
	 ...
	 */
	function updated() {
		echo '<div class="updated fade"><p><b>[Appointments+]</b> '. __( 'Ausgewählte Datensätze aktualisiert.','appointments' ).'</p></div>';
	}
}
